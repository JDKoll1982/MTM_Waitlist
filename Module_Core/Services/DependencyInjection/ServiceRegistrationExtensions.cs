...
public static class ServiceRegistrationExtensions
{
    public static IServiceCollection AddAppServices(this IServiceCollection services, HostBuilderContext context)
    {
        ...
        services.AddTransient<SetupDunnagePartViewModel>();
        services.AddTransient<SetupDunnageAddPartSelectionViewModel>();
        ...
        services.AddTransient<SetupDunnagePartPage>();
        services.AddTransient<SetupDunnageAddPartSelectionPage>();
