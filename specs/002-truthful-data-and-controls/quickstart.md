...
Runnable validation for the whole feature. Each scenario states what to run, what to look at and what a pass looks like; the contracts and the data model hold the detail.
...
- Reaching the shell needs a **signed-in account**, and the startup gate needs a reachable
  `mtm_waitlist`. Set both connection overrides before launching:
...
<!-- token-budget: compacted (level=medium) on 2026-09-12T23:51:49Z; original at quickstart.full.md -->
