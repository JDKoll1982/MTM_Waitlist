-- Master seed list: mtm_mock
-- Engine: MySQL 5.7
--
-- GENERATED by Database/CopilotScripts/build_mtm_mock_masters.ps1 â€” do not edit by hand.
-- Source: Database/Mock/Seeds/<name>/create.sql (concatenated verbatim, ordinal order).
--
-- Registered seeds: baseline mirror content (is_seed_content = 1).

USE mtm_mock;

-- ============================================================
-- Artifact: seed_visual_mirror_baseline
-- ============================================================
...
-- reporting a fabricated refresh age (FR-022, data-model.md Â§3).
--
