...
--
-- Scope: every OPEN work order (STATUS in 'R','U','F') paired with its own order part — exactly the
--        (work order, part) pairs RequestDispositionResolver asks about for a work centre's active
--        setup job.
--
...
SELECT
    'WO-' + RIGHT('000000' + LTRIM(RTRIM(wo.BASE_ID)), 6) AS WorkOrder,
