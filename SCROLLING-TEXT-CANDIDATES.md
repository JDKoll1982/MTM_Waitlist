...
| Request review blocks | `NewRequestSummaryPage.xaml` 50, 62, 75, 99, 136, 167, 178, 189, 202 (+77, 101, 191); `NewRequestPreviewPage.xaml` 50, 62, 84, 119 (+86) | Field values in a `*` column, plus the per-die detail lines |
